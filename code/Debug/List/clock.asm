...
_0x3:
	.DB  0x63,0x6C,0x6F,0x63,0x6B,0x0,0x0,0x0
	.DB  0x0,0x0,0x61,0x6C,0x61,0x72,0x6D,0x0
	.DB  0x0,0x0,0x0,0x0,0x74,0x69,0x6D,0x65
	.DB  0x72
_0x0:
	.DB  0x25,0x64,0x25,0x64,0x3A,0x25,0x64,0x25
	.DB  0x64,0x3A,0x25,0x64,0x25,0x64,0x0
_0x2020003:
	.DB  0x80,0xC0
...
; 0000 0032         timerSecond = timerSecond + 1;
	LDS  R30,_timerSecond
	LDS  R31,_timerSecond+1
	ADIW R30,1
	STS  _timerSecond,R30
	STS  _timerSecond+1,R31
; 0000 0033         if(timerSecond >= 60){
	LDS  R26,_timerSecond
	LDS  R27,_timerSecond+1
	SBIW R26,60
	BRLT _0x9
; 0000 0034             timerSecond = 0;
	LDI  R30,LOW(0)
	STS  _timerSecond,R30
	STS  _timerSecond+1,R30
; 0000 0035             timerMinute += 1;
	LDS  R30,_timerMinute
	LDS  R31,_timerMinute+1
	ADIW R30,1
	STS  _timerMinute,R30
	STS  _timerMinute+1,R31
; 0000 0036             if(timerMinute >= 60){
	LDS  R26,_timerMinute
	LDS  R27,_timerMinute+1
	SBIW R26,60
	BRLT _0xA
; 0000 0037                     timerMinute = 0;
	LDI  R30,LOW(0)
	STS  _timerMinute,R30
	STS  _timerMinute+1,R30
; 0000 0038                     timerHour += 1;
	LDS  R30,_timerHour
	LDS  R31,_timerHour+1
	ADIW R30,1
	STS  _timerHour,R30
	STS  _timerHour+1,R31
; 0000 0039             }
; 0000 003A         }
_0xA:
...
; 0000 0044         alarmsHour[alarmInd] = alarmHour;
	CALL SUBOPT_0x6
	LDI  R26,LOW(_alarmsHour)
	LDI  R27,HIGH(_alarmsHour)
	LSL  R30
	ROL  R31
	ADD  R30,R26
	ADC  R31,R27
...
; 0000 0045         alarmsMin[alarmInd] = alarmMinute;
	CALL SUBOPT_0x6
	LDI  R26,LOW(_alarmsMin)
	LDI  R27,HIGH(_alarmsMin)
	LSL  R30
	ROL  R31
	ADD  R30,R26
	ADC  R31,R27
...
SUBOPT_0x7:
	...
	ST   -Y,R13
	ST   -Y,R12
	LDS  R26,_alarmSecond
	LDS  R27,_alarmSecond+1
	RET
